        ...
        <div className="max-w-3xl w-full">
          ...
          <div className="bg-gradient-to-br from-[#1A1A1A] via-[#1A1A1A] to-[#3B82F6]/5 rounded-2xl border border-white/10 overflow-hidden">
            ...
            <div className="p-8 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-[#0A0A0A] rounded-xl p-5 border border-white/5 hover:border-[#3B82F6]/30 transition-all group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{t('bookSessions')}</h3>
                      <p className="text-sm text-gray-400">{t('bookSessionsDesc')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#0A0A0A] rounded-xl p-5 border border-white/5 hover:border-[#3B82F6]/30 transition-all group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{t('smartReminders')}</h3>
                      <p className="text-sm text-gray-400">{t('smartRemindersDesc')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#0A0A0A] rounded-xl p-5 border border-white/5 hover:border-[#3B82F6]/30 transition-all group">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#3B82F6]/20 to-[#2563EB]/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                      <Repeat className="w-6 h-6 text-[#3B82F6]" />
                    </div>
                    <div>
                      <h3 className="text-white font-semibold mb-1">{t('recurringEvents')}</h3>
                      <p className="text-sm text-gray-400">{t('recurringEventsDesc')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#0A0A0A] rounded-xl p-5 border border-white/5 hover:border-[#3B82F6]/30 transition-all group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{t('calendarSync')}</h3>
                      <p className="text-sm text-gray-400">{t('calendarSyncDesc')}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#3B82F6]/5 to-[#2563EB]/5 rounded-xl p-6 border border-[#3B82F6]/10 mb-6">
                <div className="flex items-center justify-center gap-3 mb-4">
                  <CalendarDays className="w-5 h-5 text-[#3B82F6]" />
                  <h3 className="text-white font-semibold">{t('scheduleFeatures')}</h3>
                </div>
