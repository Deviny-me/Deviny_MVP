            ...
            <div className="flex gap-5 -mt-14">
              ...
              <div className="relative z-10 flex-shrink-0 self-start">
                {trainer.avatarUrl ? (
                  ...
                  <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#f07915] to-[#d4600b] flex items-center justify-center border-4 border-white dark:border-[#1A1A1A] shadow-xl">
              ...
              <div className="flex-1 min-w-0 pt-[3.75rem] flex items-end justify-between gap-4">
                ...
                <div className="hidden sm:flex items-center gap-5">
                  <div className="group text-center">
                    <p className="text-lg font-bold text-foreground group-hover:text-[#f07915] transition-colors">{trainer.programsCount}</p>
                    <p className="text-[10px] text-muted-foreground">{t('programs')}</p>
                  </div>
                  <div className="group text-center">
                    <p className="text-lg font-bold text-foreground group-hover:text-[#f07915] transition-colors">{trainer.studentsCount}</p>
                    <p className="text-[10px] text-muted-foreground">{t('students')}</p>
                  </div>
                  <div className="group text-center">
                    <p className="text-lg font-bold text-foreground group-hover:text-[#f07915] transition-colors">{trainer.ratingValue.toFixed(1)}</p>
                    <p className="text-[10px] text-muted-foreground">{trainer.reviewsCount} {t('reviews')}</p>
                  </div>
                  <div className="group text-center">
                    <p className="text-lg font-bold text-foreground group-hover:text-[#f07915] transition-colors">{trainer.achievementsCount}</p>
