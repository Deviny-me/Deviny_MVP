...
import { nutritionistClientsApi, NutritionistClient } from '@/lib/api/nutritionistClientsApi'
...
export default function NutritionistClientsPage() {
  ...
  const [students, setStudents] = useState<NutritionistClient[]>([])
  const [filteredStudents, setFilteredStudents] = useState<NutritionistClient[]>([])
  const [loading, setLoading] = useState(true)
  const [searchQuery, setSearchQuery] = useState('')
  const [selectedStudent, setSelectedStudent] = useState<NutritionistClient | null>(null)
  ...
  const loadStudents = async () => {
    try {
      setLoading(true)
      const data = await nutritionistClientsApi.getClients()
      setStudents(data)
