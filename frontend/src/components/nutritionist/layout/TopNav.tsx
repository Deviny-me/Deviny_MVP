              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center justify-center px-5 py-2 rounded-lg transition-all ${
                    isActive(item.path)
                      ? 'text-[#28bf68] bg-[#28bf68]/[0.12] dark:bg-[#28bf68]/[0.08]'
                      : hasUnread
              ...
              >
                {profile?.trainer?.avatarUrl ? (
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover ring-2 ring-[#28bf68]/30"
                  />
                ) : (
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#28bf68] to-[#1c9e52] flex items-center justify-center ring-2 ring-[#28bf68]/30">
                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-[min(18rem,calc(100vw-1.5rem))] bg-surface-2 border border-border rounded-xl overflow-hidden z-50 animate-slide-down" style={{ boxShadow: 'var(--dropdown-shadow)' }}>
                    <div className="p-4 border-b border-border-subtle">
                      <div className="flex items-center gap-3">
                        {profile?.trainer?.avatarUrl ? (
                          <img
                            src={getMediaUrl(profile.trainer.avatarUrl) || ''}
                            alt={profile.trainer.fullName}
                            className="w-12 h-12 rounded-full object-cover ring-2 ring-[#28bf68]/30"
                          />
                        ) : (
                          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#28bf68] to-[#1c9e52] flex items-center justify-center ring-2 ring-[#28bf68]/30">
                      ...
                      {/* Level Display */}
                      {level && (
                        <div className="mt-3 p-3 bg-gradient-to-r from-[#28bf68]/[0.1] to-[#1c9e52]/[0.1] dark:from-[#28bf68]/[0.06] dark:to-[#1c9e52]/[0.06] border border-[#28bf68]/15 dark:border-[#28bf68]/10 rounded-lg">
