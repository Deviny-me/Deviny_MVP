...
namespace Deviny.Infrastructure.Migrations
{
    ...
    [Migration("20260420162213_AddNotificationCategoriesAndSettings")]
    partial class AddNotificationCategoriesAndSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Deviny.Domain.Entities.EmailOtp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deviny.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deviny.Domain.Entities.ProgramReview", b =>
                {
                    ...
                    b.HasIndex("MealProgramId", "UserId")
                        .IsUnique()
                        .HasFilter("\"MealProgramId\" IS NOT NULL");

                    b.HasIndex("TrainingProgramId", "UserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Deviny.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("InjuryDocUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Deviny.Domain.Entities.UserSettings", b =>
                {
                    ...
                    b.Property<bool>("AchievementFeedEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("ContentUpdatesEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
